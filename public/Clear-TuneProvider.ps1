function Clear-TuneProvider {
    ...
    .EXAMPLE
        ...
        This example clears the OpenAI provider configuration for finetuna, removing any persisted configuration files and resetting the environment and global scope variables.
